...
async function initDB() {
    try {
        ...
        if (rows.length === 0) {
            // SECURITY FIX: Do not hardcode a weak password. Use an env variable or a stronger fallback.
            const defaultPassword = process.env.ADMIN_DEFAULT_PASSWORD || 'SecureLawyerAdmin!2024';
            ...
            console.log(`IMPORTANT: Default admin password is set. Change it immediately after logging in!`);
        }
