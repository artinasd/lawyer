...
function Services() {
    ...
    return (
        <div className='bg-[#F9FAFB] w-full px-10 py-20 flex flex-col items-center'>
            ...
            <br/>
            <p className='text-gray-700 text-center rtl'>من در زمینه‌های مختلف حقوقی خدمات تخصصی ارائه می‌دهم.<br/>با تکیه بر دانش و تجربه، به دنبال بهترین راه‌حل برای مشکلات حقوقی شما هستم.</p>
